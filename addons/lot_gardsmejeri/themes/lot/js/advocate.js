...
// Contact form CMS fix
$('#contact_contact_email').attr('id', 'contact_email');
$('#contact_contact_phone').attr('id', 'contact_phone');
$('#contact_contact_message').attr('id', 'contact_message');
$('#contact_contact_subject').attr('id', 'contact_subject');
$('#contact_contact_name').attr('id', 'contact_name');
