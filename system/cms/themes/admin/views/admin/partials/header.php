...
<div class="topbar" dir=<?php $vars = $this->load->get_vars();
echo $vars['lang']['direction'] ?>>
    <div class="topbar-inner">
        <div class="wrapper">
            <div id="logo">
                <?php echo anchor('', Asset::img('logo.png', 'view site', ['style' => 'width:35px;margin-top:2px;']), 'target="_blank"  ') ?>
            ...
            <!--  <div class="topbar-form">
                <form class="topbar-search">
                    <input type="text" class="search-query" id="nav-search"
                           placeholder="<?php echo lang("cp:search"); ?>" ontouchstart="">
                </form>
            </div> -->
