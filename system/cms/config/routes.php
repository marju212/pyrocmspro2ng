...
$route['registrerad(/:any)?'] = 'member/registered/$1';
...
$route['medlem/(:any)'] = 'users/view/$1';
$route['profil'] = 'users/index';
$route['redigera-profil'] = 'users/edit';
...
$route['nyheter(/:any)?'] = 'news/index$1';

//Route för bockavel medlemshantering member modul
//$route['medlemshantering(/:any)?'] = 'member/$1';
