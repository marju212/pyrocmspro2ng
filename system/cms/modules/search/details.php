...
class Module_Search extends Module
{
	...
	public function install()
	{
		...
		CREATE TABLE ".$this->db->dbprefix('search_index')." (
		  ...
		  `keyword_hash` char(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
		  `module` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
		  `entry_key` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
		  `entry_plural` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
		  `entry_id` varchar(255) DEFAULT NULL,
		  `uri` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
		  `cp_edit_uri` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
		  `cp_delete_uri` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
		  PRIMARY KEY (`id`),
