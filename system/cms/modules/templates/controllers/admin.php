...
class Admin extends Admin_Controller
{
	...
	public function create()
	{
		...
		if ($this->form_validation->run())
		{
            ...
            $data['body']=$this->removeEntetiesFromPlugins($data['body']);
		...
		if ($this->form_validation->run())
		{
			...
			else
			{
				$data = array(
					...
					'subject' => $this->input->post('subject'),
					'body' => $this->removeEntetiesFromPlugins($this->input->post('body')),
    ...
    private function removeEntetiesFromPlugins($body)
    {
        // Replace HTML enteties for plugins
        // &quot;{{ }}&quot;
        // &#39;{{ }}&#39;
