    ...
    public function register()
    {
        ...
        $validation = array(
            ...
            array(
                ...
                'rules' => Settings::get('auto_username') ? '' : 'required|min_length[3]|max_length[20]|callback__username_check',
            ),
        );
        ...
        if ($_POST) {
            if ($this->form_validation->run()) {
                ...
                if ($id > 0) {
                    ...
                    Events::trigger('user_created', $id);
...
// trigger an event for third party devs
                        Events::trigger('post_user_register_email_sent', $id);
