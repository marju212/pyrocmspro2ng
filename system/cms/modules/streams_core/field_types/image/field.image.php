...
class Field_image
{
	...
	public function form_output($params)
	{
		...
		//$out = "<script>$(function() {reader.onload = function (e) { $('#".$params['form_slug']."').attr('src', e.target.result); } $('#".$params['form_slug']."').change(function(){  readURL(this); });});</script>";
        $out = "";
		...
		{
            ///$out .= '<img id="'.$params['form_slug'].'"style="visibility: hidden;" src="#" /><br />';
