		...
		else
		{
			...
			foreach ($choices as $choice_key => $choice)
			{
				...
				else
				{
					...
					$return .= '<label class="checkbox">'.form_hidden($params['form_slug'].'[]','').form_checkbox($params['form_slug'].'[]', $this->format_choice($choice_key), $selected, 'id="'.$this->format_choice($choice_key).'" '.$this->active_state($choice)).'&nbsp;'.$this->format_choice($choice).'</label>'.$line_end ;
				}
			}
		}
